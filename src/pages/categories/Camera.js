    ...
    return (
        <div className='bg-lightBg text-secondary'>
            <div className='text-center pt-10'>
                <h1 className='text-2xl lg:text-4xl font-bold text-primary'>Camera</h1>
                <h3 className='text-sm lg:text-base' >Check & Get Your Desired Camera!</h3>
            </div>
...
export const getStaticProps = async () => {
    ...
    const filteredData = data.filter(item => item.category === "Camera");
